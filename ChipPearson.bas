...
'       InsertNewElementIntoArray - JGray
'       IsArrayAllDefault
'       IsArrayAllNumeric
'       IsArrayAllocated
'       IsArrayDynamic
...
Public Function QuickSort(vArray As Variant, Optional ByVal inLow As Long = -1, Optional ByVal inHi As Long = -1) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Public Function InsertNewElementIntoArray(ByRef InputArray As Variant, _
...
If Not IsArraySorted(InputArray) Then _
...
Dim I  As Long
Dim Value   As String
Value = "2":  Debug.Print ("Value=""" & Value & """  " & InsertNewElementIntoArray(TestList, Value) & xprt(TestList))
Value = "2":  Debug.Print ("Value=""" & Value & """  " & InsertNewElementIntoArray(TestList, Value) & xprt(TestList))
Value = "5":  Debug.Print ("Value=""" & Value & """  " & InsertNewElementIntoArray(TestList, Value) & xprt(TestList))
Value = "33":  Debug.Print ("Value=""" & Value & """  " & InsertNewElementIntoArray(TestList, Value) & xprt(TestList))
Value = "3":  Debug.Print ("Value=""" & Value & """  " & InsertNewElementIntoArray(TestList, Value) & xprt(TestList))
Value = "1":  Debug.Print ("Value=""" & Value & """  " & InsertNewElementIntoArray(TestList, Value) & xprt(TestList))
Value = "3":  Debug.Print ("Value=""" & Value & """  " & InsertNewElementIntoArray(TestList, Value) & xprt(TestList))
Value = "99":  Debug.Print ("Value=""" & Value & """  " & InsertNewElementIntoArray(TestList, Value) & xprt(TestList))
Debug.Print ("---------------")

If IsArrayEmpty(TestList) Then
  Debug.Print ("Array is empty")
  Exit Function
End If
End Function

Private Function xprt(Parr As Variant) As String
Dim I As Long
